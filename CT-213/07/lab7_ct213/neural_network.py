...
class NeuralNetwork:
    ...
    def compute_gradient_back_propagation(self, inputs, expected_outputs):
        ...
        weights_gradient[1] = np.zeros((self.num_hiddens, self.num_inputs))     # Shape: Output x Input 
        weights_gradient[2] = np.zeros((self.num_outputs, self.num_hiddens))    # Shape: Output x Input 
        biases_gradient[1] = np.zeros((self.num_hiddens, 1))                    # Shape: Output x Input
        biases_gradient[2] = np.zeros((self.num_outputs, 1))                    # Shape: Output x Input
