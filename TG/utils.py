...
class Aircraft(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        for i in range(0,4):
            self.sprites.append(pg.image.load(f'model/bluedot.png').convert())
        ...
        self.image = pg.transform.scale(self.image, (SIZE_DRONE//100, SIZE_DRONE//100))
...
class FlowField():
    def __init__(self, resolution):
        ...
        # create grid
        self.field = [[vec(random.uniform(0,1),random.uniform(0,1)) for _ in range(self.cols)] for _ in range(self.rows)]  
...
class Npc_target(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        #for i in range(1,4):
        self.sprites.append(pg.image.load(f'model/reddot.png').convert())
